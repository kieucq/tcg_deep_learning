...
#for leadtime in 36; do
    ...
    python tcg_VIT_p1.py ${leadtime} ${dataroot}/${basin_train}/
   
    echo "Running Stage 2 ..."
    python tcg_VIT_p2.py ${leadtime}
 
    echo "Running Stage 3 ..."
    python tcg_VIT_p3.py ${leadtime} ${dataroot}/${basin_test}/ >& out_VIT_${basin_train}2${basin_test}.txt
