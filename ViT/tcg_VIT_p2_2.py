...
#    callbacks=[keras.callbacks.ModelCheckpoint("tcg_VIT"  + ".model_" + str(lead_time),monitor = "val_accuracy", save_weights_only=True, save_best_only=True)]
    callbacks=[keras.callbacks.ModelCheckpoint("tcg_VIT"  + ".model_" + str(lead_time) + "_2.keras", save_best_only=True)]
...
if __name__ == '__main__':
    ...
    pickle_in = open("tcg_VIT_X_2.pickle","rb")
    X = pickle.load(pickle_in)
    pickle_in = open("tcg_VIT_y_2.pickle","rb")
    ...
    with open('./tcg_histories_vit_2.pickle', 'wb') as out:
